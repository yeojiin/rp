		...
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				...
				<div class="reserveArea">
					<table style="width:100%; margin-left:auto; margin-right:auto; background:mistyrose;">
					<tr><h1 align="center" style="color:salmon; font-size:35px;">예약</h1>
					</tr>
		<tr>
  			<td class="imagetd" width="40%" height="470px">
  				<img id="image"src="<%=request.getContextPath()%>/images/dressTest.jpg">
  				<br><br>
  				<input class="form-control" id="productDetail" type="text" readonly>
  			</td>
  			...
  			<td class="visible-md visible-lg visible-sm" width="30%" style="padding:5%">
				...
				<table style="width:100%">
					...
					<tr>
						<td>
							<label>예약자</label>
							<br>
							<input class="form-control" id="userMno" type="text" style="width:100%; height:30px; float:left; margin-right :20px" 
					...
					<tr>
						<td>
							<label>가격</label>
							<br>
							<input class="form-control" id="price" type="text" style="width:100%; height:30px; float:left; margin-right :20px" readonly>
							<br><br><br>
						</td>
					</tr>
					<tr>
				...
				<div style="text-align:center">
					...
					<button class="ui gray button" id="cancle" onclick="location.href='views/member/m_reservation.jsp'">취소</button>
				</div>
